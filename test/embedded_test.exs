defmodule AshPhoenixTranslations.EmbeddedTest do
  ...
  describe "update_embedded_translation/4" do
    test "updates nested translation" do
      ...
      {:ok, updated} = Embedded.update_embedded_translation(
        user,
        [:address, :street],
        :es,
        "Calle Principal"
    ...
    test "handles invalid path" do
      ...
      result = Embedded.update_embedded_translation(
        user,
        [:invalid, :path],
        :es,
        "value"
  ...
  describe "merge_embedded_translations/3" do
    test "merges translations with merge strategy" do
      ...
      {:ok, merged} = Embedded.merge_embedded_translations(
        user,
        new_translations,
        strategy: :merge
      )
    ...
    test "replaces translations with replace strategy" do
      ...
      {:ok, replaced} = Embedded.merge_embedded_translations(
        user,
        new_translations,
        strategy: :replace
      )
    ...
    test "fills missing translations with fill strategy" do
      ...
      {:ok, filled} = Embedded.merge_embedded_translations(
        user,
        new_translations,
        strategy: :fill
      )
